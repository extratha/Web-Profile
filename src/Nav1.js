                ...
                <div className="nav-wrap backblur ">
                    ...
                    <div className={navStatus} id="nav-canvas">
                        <div className="canvas-list px-3 mt-2 mb-5">
                            <button className="btn btn-light btncross" type="button"
                    ...
                    <nav className="navbar navbar-expand-md navtheme px-4" >
                        <div className="collapse navbar-collapse mx-auto  " style={{ width: '80%', display: 'flex' }}>
                            <Link
                            ...
                            <div className="collapse navbar-collapse "  >
                                ...
                                <ul className=" position-sticky custom-font-menu flex-row align-middle" style={{ margin: '0px' }} >
